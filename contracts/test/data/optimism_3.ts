...
export const orderParams = {
  parameters: {
    ...
    offer: [
      {
        itemType: 2,
        token: "0x74A002D13f5F8AF7f9A971f006B9a46c9b31DaBD",
        identifierOrCriteria: "85561",
        startAmount: "1",
        endAmount: "1",
      },
    ],
    consideration: [
      {
        ...
        startAmount: "5250000000000",
        endAmount: "5250000000000",
        recipient: "0xeC1557A67d4980C948cD473075293204F4D280fd",
      },
      {
        itemType: 0,
        token: "0x0000000000000000000000000000000000000000",
        identifierOrCriteria: 0,
        startAmount: "204750000000000",
        endAmount: "204750000000000",
        recipient: "0x213b06991AA086F89240618eea8dA79Cf6A3262D",
      },
    ],
    orderType: 2,
