...
interface TestDefenDAOInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mockExecute(uint256,uint256,address,uint256)": FunctionFragment;
    "mockExecuteWithRecord(uint256,uint256,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mockExecute",
    values: [BigNumberish, BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "mockExecuteWithRecord",
    values: [BigNumberish, BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class TestDefenDAO extends BaseContract {
  ...
  interface: TestDefenDAOInterface;
  ...
  functions: {
    ...
    mockExecute(
      ...
      nftId: BigNumberish,
      claimer: string,
      luckyIndex: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    mockExecuteWithRecord(
      price: BigNumberish,
      nftId: BigNumberish,
      claimer: string,
      luckyIndex: BigNumberish,
