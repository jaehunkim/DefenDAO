...
interface TestDefenDAOFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mockRecordRecentSold(address,uint256,uint256,address,string,string)": FunctionFragment;
...
export class TestDefenDAOFactory extends BaseContract {
  ...
  interface: TestDefenDAOFactoryInterface;
